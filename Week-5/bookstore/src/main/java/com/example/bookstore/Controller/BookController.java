...
import com.example.bookstore.EntityMapping.EntityMapper;
...
public class BookController {
    ...
    //Exercise-3: GET method to filter books by title and author using query parameters
    @GetMapping("/search")
